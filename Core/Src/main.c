...
volatile uint32_t g_ibus_uart_error_count;
volatile uint32_t g_ibus_uart_last_error;
...
int main(void)
{
  ...
  g_ibus_uart_rx_status = HAL_UART_Receive_IT(&huart2,
                                              &s_ibus_rx_byte,
                                              1U);
  if (g_ibus_uart_rx_status != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
    ...
    else if (huart->Instance == USART2)
    {
        ...
        g_ibus_uart_rx_status = HAL_UART_Receive_IT(huart,
                                                    &s_ibus_rx_byte,
                                                    1U);
    }
}
...
void HAL_UART_ErrorCallback(UART_HandleTypeDef *huart)
{
    ...
    else if (huart->Instance == USART2)
    {
        ...
        {
            /* Some recoverable UART errors leave the current receive active. */
            g_ibus_uart_rx_status = HAL_OK;
        }
    }
}
